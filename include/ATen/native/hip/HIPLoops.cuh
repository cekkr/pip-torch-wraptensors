...
static inline void launch_vectorized_kernel(
  ...
  switch (vec_size) {
    case 4:
     hipLaunchKernelGGL(( vectorized_elementwise_kernel<4, func_t, array_t>)
          , dim3(grid), dim3(num_threads()), 0, stream, N, f, data);
      C10_HIP_KERNEL_LAUNCH_CHECK();
      break;
    case 2:
     hipLaunchKernelGGL(( vectorized_elementwise_kernel<2, func_t, array_t>)
          , dim3(grid), dim3(num_threads()), 0, stream, N, f, data);
      C10_HIP_KERNEL_LAUNCH_CHECK();
      break;
    case 1: {
      ...
      auto loader = memory::LoadWithoutCast();
      auto storer = memory::StoreWithoutCast();
     hipLaunchKernelGGL(( unrolled_elementwise_kernel<func_t, array_t>)
          , dim3(grid), dim3(num_threads()), 0, stream, 
...
static inline void launch_unrolled_kernel(
  ...
  auto stream = at::hip::getCurrentHIPStreamMasqueradingAsCUDA();
 hipLaunchKernelGGL(( unrolled_elementwise_kernel<func_t, array_t>)
      , dim3(grid), dim3(num_threads()), 0, stream, N, f, data, ic, oc, l, s);
  C10_HIP_KERNEL_LAUNCH_CHECK();
}
...
static void launch_legacy_kernel(int64_t N, const func_t& f) {
  ...
  auto stream = at::hip::getCurrentHIPStreamMasqueradingAsCUDA();
 hipLaunchKernelGGL(( elementwise_kernel<nt, vt, func_t>), dim3(grid), dim3(block), 0, stream, N, f);
  C10_HIP_KERNEL_LAUNCH_CHECK();
}
