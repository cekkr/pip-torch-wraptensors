...
__host__ void scan_innermost_dim_with_indices(
 ...
 hipLaunchKernelGGL(( tensor_kernel_scan_innermost_dim_with_indices<scalar_t>), dim3(grid), dim3(threads), mem_size,
...
void scan_innermost_dim(const TensorBase& self, const TensorBase& result,
 ...
 hipLaunchKernelGGL(( tensor_kernel_scan_innermost_dim<scalar_t>), dim3(grid), dim3(threads), num_threads * 2 * sizeof(scalar_t),
                                               at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
    result.mutable_data_ptr<scalar_t>(), self.const_data_ptr<scalar_t>(),
